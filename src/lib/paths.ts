...
export const GUIDE_SEGMENT: Record<Locale, string> = {
  es: "que-hacer-en-la-costa-de-la-luz",
  en: "things-to-do-costa-de-la-luz",
  de: "was-tun-costa-de-la-luz",
...
export function localizedGuideHrefs(): Record<Locale, string> {
